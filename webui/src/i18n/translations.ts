...
const EXACT_ZH_TO_EN: Record<string, string> = {
  ...
  "集中管理可供各平台使用的 CA 证书。导入证书不会自动改变任何平台的校验方式。":
    "Manage CA certificates that platforms can use. Importing a certificate does not change any platform's verification settings.",
  "导入证书": "Import Certificate",
  "导入中...": "Importing...",
  "CA 证书已导入": "CA certificate imported",
  "CA 证书已删除": "CA certificate deleted",
  "已导入的证书": "Imported Certificates",
  "共 {{count}} 个": "{{count}} total",
  "粘贴一个或多个 PEM 格式的 CA 证书。不要包含私钥或服务端证书。":
    "Paste one or more PEM-formatted CA certificates. Do not include private keys or server certificates.",
  "在平台的配置页面中选择证书后，该平台的 HTTPS 反向代理请求将使用它进行校验。":
    "Select a certificate on a platform's configuration page to use it for that platform's HTTPS reverse-proxy requests.",
  "正在加载 CA 证书...": "Loading CA certificates...",
  "还没有导入 CA 证书": "No CA certificates imported",
  "CA 证书 PEM": "CA certificate PEM",
  "请输入一个或多个 CA 证书 PEM": "Enter one or more CA certificates in PEM format",
  "证书 ID": "Certificate ID",
  "证书": "Certificate",
  "SHA-256 指纹": "SHA-256 Fingerprint",
  "证书数量": "Certificate Count",
  "最早到期": "Earliest Expiry",
  "使用中的平台": "Platforms Using It",
  "证书仍被平台使用，无法删除": "This certificate is still used by a platform and cannot be deleted",
  "删除 CA 证书": "Delete CA Certificate",
  "确认删除此 CA 证书？": "Delete this CA certificate?",
  "HTTPS 证书校验": "HTTPS Certificate Verification",
  "平台策略与证书校验": "Platform policies and certificate verification",
  "修改平台策略与 HTTPS 证书校验后统一保存。":
    "Update platform policies and HTTPS certificate verification, then save them together.",
  "设置将应用于此平台的所有 HTTPS 反向代理请求。未配置时使用系统证书。":
    "This setting applies to every HTTPS reverse-proxy request on this platform. System certificates are used by default.",
  "正在加载 HTTPS 证书校验设置...": "Loading HTTPS certificate verification settings...",
  "Default 平台固定使用系统证书，不能修改证书校验方式。":
    "The Default platform always uses system certificates and its verification method cannot be changed.",
  "证书校验方式": "Certificate Verification Method",
  "使用系统证书": "Use System Certificates",
  "使用自定义 CA 证书": "Use a Custom CA Certificate",
  "跳过证书校验": "Skip Certificate Verification",
  "此设置会让此平台的所有 HTTPS 反向代理请求跳过证书颁发机构、有效期和目标域名校验，请谨慎使用。":
    "This setting skips certificate authority, expiry, and hostname checks for every HTTPS reverse-proxy request on this platform. Use it with caution.",
  "请选择 CA 证书": "Select a CA certificate",
  "请选择一个 CA 证书": "Select a CA certificate",
  "还没有 CA 证书，请先导入": "No CA certificates are available. Import one first.",
  "当前 CA 证书不可用，请重新选择": "The current CA certificate is unavailable. Select another certificate.",
  "在新标签页中导入证书": "Import a certificate in a new tab",
  "跳过证书校验的原因（必填）": "Reason for Skipping Verification (Required)",
  "本次变更原因（必填）": "Reason for This Change (Required)",
  "请说明原因": "Describe the reason",
  "启用、延长期限或改为长期有效时需要填写":
    "Required when enabling, extending, or removing automatic expiry",
  "跳过证书校验时必须填写原因": "A reason is required when skipping certificate verification",
  "有效期": "Validity",
  "到指定时间": "Until a Specific Time",
  "长期有效": "No Automatic Expiry",
  "到期时间": "Expiry Time",
  "到期时间必须在未来": "The expiry time must be in the future",
  "确认保存以下 HTTPS 证书校验变更？\n{{summary}}":
    "Save the following HTTPS certificate verification change?\n{{summary}}",
  "当前配置尚未保存，确认放弃修改？": "This configuration has unsaved changes. Discard them?",
  "配置已在其他位置更新。你的修改仍保留，请载入最新配置后重新编辑。":
    "This configuration was updated elsewhere. Your draft is preserved; load the latest configuration before editing again.",
  "载入最新配置": "Load Latest Configuration",
  "HTTPS 证书校验设置已保存": "HTTPS certificate verification settings saved",
  "已恢复为使用系统证书": "Restored system certificate verification",
  "恢复为使用系统证书": "Restore System Certificates",
  "当前设置": "Current Setting",
  "配置状态": "Configured State",
  "当前生效": "Currently Effective",
  "已到期": "Expired",
  "当前原因": "Current Reason",
  "到期": "Expires",
  "保存": "Save",
...
Note: Once enabled, requests without authentication information are rejected instead of being treated as Default platform requests.`,
  ...
  "恢复平台的所有默认设置，包括 HTTPS 证书校验。":
    "Restore all platform defaults, including HTTPS certificate verification.",
